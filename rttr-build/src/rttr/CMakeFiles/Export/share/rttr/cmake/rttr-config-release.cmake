...
set_target_properties(RTTR::Core PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/librttr_core.so.0.9.6"
  IMPORTED_SONAME_RELEASE "librttr_core.so.0.9.6"
  )

list(APPEND _IMPORT_CHECK_TARGETS RTTR::Core )
list(APPEND _IMPORT_CHECK_FILES_FOR_RTTR::Core "${_IMPORT_PREFIX}/lib/librttr_core.so.0.9.6" )
